  ...
  return (
    <section id="collection" ref={ref} className="py-20 lg:py-28 px-5 lg:px-10 max-w-7xl mx-auto">
      ...
      <div className="text-center mb-14 reveal">
        <p className="text-[9px] tracking-[0.4em] uppercase mb-4 font-[400]"
          style={{ fontFamily: "var(--font-sans)", color: "var(--gold)" }}>
          Нашата Колекција
        </p>
        <h2 className="text-4xl lg:text-5xl font-[300] leading-tight mb-5"
          style={{ fontFamily: "var(--font-serif)", color: "var(--onyx)" }}>
          Инспирирани мириси
        </h2>
        <div className="h-px w-16 mx-auto mb-5"
          style={{ background: "linear-gradient(90deg, transparent, var(--gold), transparent)" }} />
        <p className="text-sm font-[300] max-w-sm mx-auto leading-relaxed"
